...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3" style="position: relative;"> <!-- Pastikan sidebar memiliki position relative -->
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="images/dd.jpg" alt="" style="width: 40px; height: 40px;">
                        <div
                            class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1">
                        </div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">Deboyy</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('qrcode.form') }}" class="nav-item nav-link">
                        <i class="fa fa-qrcode me-2"></i>QR Code
                    </a>
                </div>

                <!-- Watermark Logo di bawah QR Code -->
                <div class="watermark">
                    <img src="images/logo.png" alt="Watermark Logo">
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->

        <!-- CSS untuk penempatan watermark -->
        <style>
            .watermark {
                position: absolute;
                bottom: 20px;
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="images/dd.jpg" alt=""
                                style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">Deboyy</span>
                        </a>
